...
@section('content')
    ...
    @if($won == true)
            <div class="container-fluid bg-primary p-2 rounded"> <h1 class="text-white">You won</h1></div>
    @else
            <div class="container-fluid bg-danger p-2 rounded"> <h1 class="text-white">You lost</h1></div>
    @endif
    </div>
    <div class="row">
        <div class="card col-md-4">
            <img class="card-img-top" src="" />
                <div class="card-body">
                    ...
                    <a class="btn btn-primary" data-toggle="collapse" href="#userList" role="button" aria-expanded="false" aria-controls="collapseExample">Show/Hide</a>
                    </div>
        ...
        <div class="card col-md-4 ml-auto">
            <img class="card-img-top" src="{{asset($enemy->image_path)}}">
                <div class="card-body">
                    ...
                    <div class="card-body text-center">
                        <a class="btn btn-primary" data-toggle="collapse" href="#enemyList" role="button" aria-expanded="false" aria-controls="collapseExample">Show/Hide</a>
                    </div>
